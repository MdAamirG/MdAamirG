...
| Project | Tech | Impact |
|--------|------|--------|
| 🌐 **Multilingual RAG Government Assistant** | LLMs, FAISS, FastAPI, Telegram | 90% ↓ hallucinations, <1s latency, 200+ users |
| 🎵 **Serverless Music Streaming** | AWS Lambda, S3, DynamoDB, CloudFront | Latency 500ms → <100ms, 100K concurrent, AI recommendations |
| 🩺 **AI Elderly Care Platform** | React Native, Gemini, Firebase | 40% faster emergency response, real‑time sync, role‑based access |
| 🔬 **Skin Cancer Detection & Summarisation** | CNN, LLM, Flask | 92% accuracy, 70% ↓ turnaround time, structured reports |
